...
{
    public abstract class MOISExample
    {
        ...
        protected virtual void HandleInput(FrameEvent evt)
        {
            ...
            if (input.IsKeyDown(MOIS.KeyCode.KC_ESCAPE))
            {
                // stop rendering loop
                shutDown = true;
            }

            if (input.IsKeyDown(MOIS.KeyCode.KC_A))
            {
            ...
            if (input.IsKeyDown(MOIS.KeyCode.KC_W))
            {
            ...
            if (input.IsKeyDown(MOIS.KeyCode.KC_LEFT))
            {
                camera.Yaw(scaleRotate);
            }

            if (input.IsKeyDown(MOIS.KeyCode.KC_RIGHT))
            {
                camera.Yaw(-scaleRotate);
            }

            if (input.IsKeyDown(MOIS.KeyCode.KC_UP))
            {
                camera.Pitch(scaleRotate);
            }

            if (input.IsKeyDown(MOIS.KeyCode.KC_DOWN))
            {
                camera.Pitch(-scaleRotate);
            }
            ...
            if (input.IsKeyDown(MOIS.KeyCode.KC_R) && toggleDelay < 0)
            {
            ...
            if (input.IsKeyDown(MOIS.KeyCode.KC_T) && toggleDelay < 0)
            {
            ...
            if (input.IsKeyDown(MOIS.KeyCode.KC_APOSTROPHE))
            {
            ...
            if (input.IsKeyDown(MOIS.KeyCode.KC_B))
            {
                sceneMgr.ShowBoundingBoxes = !sceneMgr.ShowBoundingBoxes;
            }

            if (input.IsKeyDown(MOIS.KeyCode.KC_F))
            {
        ...
        protected void UpdateStats()
        {
            ...
            try
            {
                ...
                guiDbg.Caption = window.DebugText;
            }
            catch
            {
                // ignore
