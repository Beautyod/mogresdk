...
[Run]
Filename: {win}\Microsoft.NET\Framework\v2.0.50727\ngen.exe; Parameters: "install ""{app}\bin\Release\browser.exe"""; WorkingDir: {app}; StatusMsg: Optimizing performance for your system ...; Flags: runhidden postinstall
Filename: {win}\Microsoft.NET\Framework\v2.0.50727\ngen.exe; Parameters: "install ""{app}\bin\Release\Mogre.dll"""; WorkingDir: {app}; StatusMsg: Optimizing performance for your system ...; Flags: runhidden postinstall
Filename: {tmp}\7z.exe; Parameters: e pdb_d.zip -o{app}\bin\Debug; WorkingDir: {tmp}; Components: Debug_symbols; Languages: ; StatusMsg: Extracting downloaded debug symbols for debug binaries; Flags: runhidden postinstall
Filename: {tmp}\7z.exe; Parameters: e pdb.zip -o{app}\bin\Release; WorkingDir: {tmp}; Components: Debug_symbols; Languages: ; StatusMsg: Extracting downloaded debug symbols for release binaries; Flags: runhidden postinstall
Filename: {app}\dependencycheck.exe; WorkingDir: {app}; StatusMsg: Checking for required dependencies ...; Flags: nowait; Languages: 

[Components]
Name: Debug_symbols; Description: Debug symbols for Mogre.dll and OgreMain.dll; ExtraDiskSpaceRequired: 22374400; Types: custom

[_ISToolDownload]
Source: http://mogresdk.googlecode.com/svn/trunk/sdk_fs_optional/bin/Release/pdb.7z; DestDir: {tmp}; DestName: mogresdk; Components: Debug_symbols
Source: http://mogresdk.googlecode.com/svn/trunk/sdk_fs_optional/bin/Debug/pdb_d.7z; DestDir: {tmp}; DestName: mogresdk; Components: Debug_symbols
Source: http://mogresdk.googlecode.com/svn/trunk/installer/tmp/7z.exe; DestDir: {tmp}; DestName: mogresdk; Components: Debug_symbols
Source: http://mogresdk.googlecode.com/svn/trunk/installer/tmp/7z.dll; DestDir: {tmp}; DestName: mogresdk; Components: Debug_symbols
[Code]
