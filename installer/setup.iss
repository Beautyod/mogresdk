...
#define MyAppVerName "MOGRE SDK 1.7.1 beta"
...
OutputDir=output
OutputBaseFilename=MogreSDK_1.7.1_beta
...
[_ISToolDownload]
; Change these links appropriately
Source: http://mogresdk.googlecode.com/svn-history/r72/trunk/sdk_fs_optional/bin/Release/pdb.7z; DestDir: {tmp}; DestName: pdb.7z; Components: Debug_symbols
Source: http://mogresdk.googlecode.com/svn-history/r72/trunk/sdk_fs_optional/bin/Release/pdb.7z; DestDir: {tmp}; DestName: pdb_d.7z; Components: Debug_symbols
Source: http://mogresdk.googlecode.com/svn-history/r72/trunk/installer/tmp/7z.exe; DestDir: {tmp}; DestName: 7z.exe; Components: Debug_symbols
Source: http://mogresdk.googlecode.com/svn-history/r72/trunk/installer/tmp/7z.dll; DestDir: {tmp}; DestName: 7z.dll; Components: Debug_symbols
[Code]
